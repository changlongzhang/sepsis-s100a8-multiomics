...
formal_dir <- file.path(root, "PONE-D-26-24904_revision_submission_package", "02_FINAL_SUBMISSION_PACKAGE", "Supporting_Figures")
...
ggsave(file.path(formal_dir, "S1_Fig.pdf"), s1, width = 7.5, height = 8.75,
       device = cairo_pdf, family = font_family, bg = "white")
