...
out_dir <- file.path(root, "work", "final_revision_20260908", "wgcna_allgenes_rerun")
...
cat("WGCNA ALL-GENE COMPARABILITY RERUN\n")
...
parameters <- data.frame(
  ...
  value = c("log2 RMA", "maximum probe per gene", "all genes with finite, nonzero variance; no label-based filtering",
